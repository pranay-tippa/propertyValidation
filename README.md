...
## Environments
- Preview: https://main--propertyValidation--pranay-tippa.hlx.page/
- Live: https://main--propertyValidation--pranay-tippa.hlx.live/
...
1. Open the `propertyValidation` directory in your favorite IDE and start coding :)
